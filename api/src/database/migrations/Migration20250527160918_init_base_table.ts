...
export class Migration20250527160918_init_base_table extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(
      `alter table "administrator" add constraint "administrator_email_unique" unique ("email");`,
    );
    ...
    this.addSql(
      `alter table "user" add constraint "user_avatar_id_foreign" foreign key ("avatar_id") references "file_storage_information" ("id") on update cascade;`,
    );
